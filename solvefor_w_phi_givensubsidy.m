...
function [W,PHI,S,PworkYWM,MWM,THome_CohortOrder]=solvefor_w_phi_givensubsidy(wm_tauw_mat,wm_tauh_mat,eta,beta,theta,gam,sigma,PhiKeyOcc,OccupationtoIdentifyPhi,lambda,Tbar,ShowData);
...
function [error,pHomeEst,THome,mwm,Pwork,s,phi,w]=solveWHome(wm_tauw,wm_tauh,wHome,wagebar,p,lambda,beta,eta,theta,gam,FARM,PhiKeyOcc,pHome,thome,Tbar);
